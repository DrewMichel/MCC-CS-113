package edu.miracosta.cs113.hw010.project1;
...
/**
 * Created by Andrew Michel on 4/23/2017.
 *
 *     Programming Project 2, pg 416.
 *      Use a HashtableChain to store the frequency counts for all the words
 *      in a large text document.  When you are done, display the
 *      contents of this HashtableChain.  Next, create a set view of the Map
...
public class Driver
{
    ...
    {
        Map<String, Integer> map = new HashtableChain<>();
        ...
        System.out.println("PRESORT HASHTABLECHAIN:\n");
        displayMap(map);
