...
package edu.miracosta.cs113.hw011.project1.studentcode;
...
// Programming exercise 6, chapter 6, page 357

    /**
     * Traverses through the BinarySearchTree nodes in a breadth-first order
     * and appends all data within the nodes into a StringBuilder
     * @return a String containing all elements within the BinarySearchTree
     */
